...
- `require_data_stream` (optional): Require that the Elasticsearch destination is a data stream, and not a plain old index. Defaults to true for "OTel-native" mapping mode, false for all others.
