...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/extension/ackextension v0.118.0
...
require (
	...
	go.opentelemetry.io/collector/exporter v0.118.1-0.20250123125445-24f88da7b583 // indirect
