...
func TestMetricsBuilderConfig(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					SqlserverActiveTempTables:                   MetricConfig{Enabled: true},
					SqlserverBackupOrRestore:                    MetricConfig{Enabled: true},
					...
					SqlserverDeadlocks:                          MetricConfig{Enabled: true},
					SqlserverExecutionErrors:                    MetricConfig{Enabled: true},
					SqlserverFreeListStalls:                     MetricConfig{Enabled: true},
					SqlserverFreeSpaceTempdb:                    MetricConfig{Enabled: true},
					SqlserverFullScans:                          MetricConfig{Enabled: true},
					SqlserverIndexSearches:                      MetricConfig{Enabled: true},
					SqlserverLockWaitRate:                       MetricConfig{Enabled: true},
					SqlserverLockWaitTimeAvg:                    MetricConfig{Enabled: true},
					SqlserverLockTimeouts:                       MetricConfig{Enabled: true},
					SqlserverLogins:                             MetricConfig{Enabled: true},
					SqlserverLogouts:                            MetricConfig{Enabled: true},
					SqlserverMemoryGrantsPending:                MetricConfig{Enabled: true},
					SqlserverMirrorWriteTransaction:             MetricConfig{Enabled: true},
					...
					SqlserverPageLookups:                        MetricConfig{Enabled: true},
					SqlserverProcessesBlocked:                   MetricConfig{Enabled: true},
					SqlserverReplicaReceived:                    MetricConfig{Enabled: true},
					SqlserverReplicaSent:                        MetricConfig{Enabled: true},
					...
					SqlserverTransactionDelays:                  MetricConfig{Enabled: true},
					...
					SqlserverUsedMemory:                         MetricConfig{Enabled: true},
					SqlserverUserConnectionCount:                MetricConfig{Enabled: true},
					SqlserverVersionStoreSize:                   MetricConfig{Enabled: true},
				},
		...
		},
		{
			...
			want: MetricsBuilderConfig{
				Metrics: MetricsConfig{
					SqlserverActiveTempTables:                   MetricConfig{Enabled: false},
					SqlserverBackupOrRestore:                    MetricConfig{Enabled: false},
					...
					SqlserverDeadlocks:                          MetricConfig{Enabled: false},
					SqlserverExecutionErrors:                    MetricConfig{Enabled: false},
					SqlserverFreeListStalls:                     MetricConfig{Enabled: false},
					SqlserverFreeSpaceTempdb:                    MetricConfig{Enabled: false},
					SqlserverFullScans:                          MetricConfig{Enabled: false},
					SqlserverIndexSearches:                      MetricConfig{Enabled: false},
					SqlserverLockWaitRate:                       MetricConfig{Enabled: false},
					SqlserverLockWaitTimeAvg:                    MetricConfig{Enabled: false},
					SqlserverLockTimeouts:                       MetricConfig{Enabled: false},
					SqlserverLogins:                             MetricConfig{Enabled: false},
					SqlserverLogouts:                            MetricConfig{Enabled: false},
					SqlserverMemoryGrantsPending:                MetricConfig{Enabled: false},
					SqlserverMirrorWriteTransaction:             MetricConfig{Enabled: false},
					...
					SqlserverPageLookups:                        MetricConfig{Enabled: false},
					SqlserverProcessesBlocked:                   MetricConfig{Enabled: false},
					SqlserverReplicaReceived:                    MetricConfig{Enabled: false},
					SqlserverReplicaSent:                        MetricConfig{Enabled: false},
					...
					SqlserverTransactionDelays:                  MetricConfig{Enabled: false},
					...
					SqlserverUsedMemory:                         MetricConfig{Enabled: false},
					SqlserverUserConnectionCount:                MetricConfig{Enabled: false},
					SqlserverVersionStoreSize:                   MetricConfig{Enabled: false},
				},
				ResourceAttributes: ResourceAttributesConfig{
