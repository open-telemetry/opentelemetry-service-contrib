...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/pkg/translator/signalfx v0.117.0
...
require (
	...
	github.com/open-telemetry/opentelemetry-collector-contrib/internal/batchperresourceattr v0.117.0 // indirect
